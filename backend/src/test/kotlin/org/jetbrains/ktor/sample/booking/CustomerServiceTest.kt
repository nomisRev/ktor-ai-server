...
class CustomerServiceTest : DatabaseSpec() {
    ...
    fun `test update customer`() = runBlocking {
        ...
        val updatedCustomer =
            customerService.updateCustomer(createdCustomer.id!!, name = newName, email = newEmail)
    ...
    fun `test partial update customer`() = runBlocking {
        ...
        val updatedCustomer =
            customerService.updateCustomer(createdCustomer.id!!, name = newName, email = null)
